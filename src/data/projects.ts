...
const projects: Project[] = [  {
    ...
    fullDescription: 
      "At FanBox, we found traditional research panels unreliable and expensive. Instead of paying people $10 to answer tedious questionnaires, we created entertaining research events where audience members actually want to participate.\n\n" +
      "The Album Cover Generator is a great example. I designed and built an app where users create custom album artwork by choosing visual and stylistic elements. Behind the scenes, it generates a custom prompt and uses OpenAI's latest image generation model to create the image. While users have fun creating, we collect rich behavioral and psychometric data, for instance how mood and music influence users' decision making.\n\n" +
      "One challenge was integration. Image generation takes about a minute, so instead of making users wait, I used the existing infrastructure for post and comment replies to deliver the result once ready. This kept the experience fast and fluid. I was also responsible for pricing of the feature. Since generation costs can add up, I implemented a model that included bundles and usage limits, maximizing engagement while keeping the feature sustainable.\n\n" +
      "Today, this tool is one of FanBox's strongest drivers of engagement and a powerful source of data.",
...

  {
    ...
    fullDescription: 
      "While I personally prefer working with raw spreadsheet data or interactive Tableau dashboards, our clients consistently request their insights delivered in PowerPoint format. This makes sense for their workflow, since they often just want to copy a few slides directly into their own deck. Tableau's export feature is limited to static images that do not integrate well into presentations. There are workarounds like using TabPy or Tableau Prep for automation, but in practice, our studio clients do not engage with Tableau-based solutions, which is why it is not part of the FanBox stack. So, long decks with many similar slides it is.\n\n" +
      "Historically, these decks have been a time sink. Once the layout is done, the rest is soul-crushing mechanical work that wastes the time of staff who are far too talented to be copying and pasting data into templates.\n\n" +
      "To cut this waste, I automated the process. The system supports CSV files, JSON, or direct SQL queries, and builds the majority of report slides with all the charts and tables our clients expect, with just a click of a button.\n\n" +
      "This automation not only saves hours of work, it also improves reliability by reducing human error and preserves the sanity of our team. Now our analysts can focus on insights instead of formatting, and clients still get the PowerPoint slides they love.",
  ...
  },
  {
    ...
    fullDescription: 
      "FanBox has traditionally focused on research for the entertainment sector, primarily serving the music and film industries. I identified an opportunity to expand our business into the untapped live entertainment sector, particularly Broadway and West End productions.\n\n" +
      "Through industry contacts and targeted outreach, I connected with a leading media agency that manages marketing for major theatrical shows. My pitch focused on giving their clients access to first-party audience data and behavioral insights that had previously been out of reach. This included helping them understand which creative assets perform best, how to structure and edit campaign content, and when to release different formats based on audience response patterns. The goal was to sharpen both targeting and creative execution throughout the campaign lifecycle.\n\n" +
      "From initial prospecting and presales to designing research tailored for live productions, I adapted our existing offerings to better serve this sector. We secured a trial project to prove our value, then successfully closed the deal, positioning FanBox as a trusted research partner in this new vertical.\n\n" +
      "This initiative not only diversified our client base but also opened up strategic growth opportunities for FanBox in the live events and performing arts space.",
  ...
  },
  {
    ...
    fullDescription: 
      "Popcorn Insider is one of my ongoing projects at FanBox. It is a weekly newsletter that explores box office performance, marketing effectiveness, and audience behavior in the film industry. Each issue focuses on a specific case study, breaking down what worked, what failed, and why.\n\n" +
      "Each edition of Popcorn Insider includes clear recommendations that studios can apply directly, from improving audience targeting to sharpening creative asset development. It showcases FanBox's research capabilities, positions us as a thought leader in entertainment marketing, and provides real strategic value to studio partners.\n\n" +
      "I designed the newsletter to be part of our broader content strategy and a part of a feedback loop between the research team's early findings and the public-facing insights we share with the industry and consumers. Insights gathered through psychometrics, social listening, and behavioral data from the Popcorn platform are translated into accessible and actionable guidance for film marketers. These insights also feed into other content formats such as YouTube videos, social media engagement, and infographic campaigns across our distribution channels.\n\n" +
      "The newsletter has achieved a consistent 24% opening rate among industry professionals, significantly outperforming the entertainment sector average. It has also become a consistent source of new business inquiries from marketing teams that want to avoid the mistakes we analyze and learn from in each edition.",
  ...
  },
  {
    ...
    fullDescription: 
      "Over the past five years, I've served as Dungeon Master for two ongoing D&D campaigns. What began as a reworked version of Lost Mine of Phandelver grew into an original world with its own cultures, histories, mythologies, architecture, and even a constructed language.\n\n" +
      "Several players expressed interest in DMing but were hesitant due to time constraints, rules complexity, or stage fright. Moreover, they didn't want to leave the world we had built together.\n\n" +
      "To address this, I created a simple but structured collaborative system. Each player received a random selection of 3D-printed miniatures, along with access to a shared document bank I built. The goal was to provide just enough structure to overcome blank page intimidation, while still preserving full creative freedom. Players could develop characters inspired by their miniatures without the pressure of DMing or designing full adventures. Many of these creations are now woven into the campaign as NPCs, historical figures, and potential plot hooks.\n\n" +
      "This approach brought fresh energy to the campaign and gave players a deeper sense of ownership over the world. What began as a Christmas gift has grown into an ongoing creative partnership and one of the most rewarding aspects of our game.",
